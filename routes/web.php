...
Route::get('/password-recovery/{token}','SiteController@recoverPassword');
...
Route::group(['middleware'=>'auth'], function() {
    ...
    Route::group(['middleware'=>'admin','prefix'=>'admin'], function() {
        ...
        Route::get('/download-participants', 'AdminController@downloadParticipants');

        Route::get('/bulk-mail', 'AdminController@bulkMail');
        Route::post('/bulk-mail', 'AdminController@sendBulkMail');
